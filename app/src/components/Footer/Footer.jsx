...
function Footer(){
    return(
        <>
            <div className="asus:flex asus:items-center asus:space-x-24 desk:flex gal:px-6 gal:py-8 desk:space-x-8 desk:space-y-4 desk:py-12" id="footer">
                <div className="desk:space-y-12 asus:w-4/12 desk:w-full desk:flex desk:flex-col desk:items-center">
